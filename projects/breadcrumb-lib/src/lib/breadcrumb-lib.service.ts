...
export class BreadcrumbLibService {
     ...
     * When a matching url is navigatedd to, the callback function is invoked to get the name to be displayed in the breadcrumb.
     */
